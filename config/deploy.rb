...
ssh_options[:keys] = %w(~/.ssh/sai-3ko) # You really should use public keys. It's much easier. Make sure it works on your repo too.
# ssh_options[:port] = 25

set :ip, '173.203.98.154' # IP of repository. Better than using DNS lookups, if it's static
